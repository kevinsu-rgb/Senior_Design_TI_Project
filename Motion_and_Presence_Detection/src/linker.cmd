...
SECTIONS
{
    ...
    .bss:    {} palign(8) > M4F_RAM12 | M4F_RAM2   /* This is where uninitialized globals go */
    RUN_START(__BSS_START)
    RUN_END(__BSS_END)
    .text:   {} align(8) >> M4F_RAM12 | M4F_RAM3 | M4F_RAM2    /* This is where code resides */
    .data:   {} align(8) >> M4F_RAM12 | M4F_RAM3 | M4F_RAM2    /* This is where initialized globals and static go */
    .rodata: {} align(8) >> M4F_RAM12 | M4F_RAM3 | M4F_RAM2    /* This is where const's go */
...
MEMORY
{
    ...
    M4F_RAM12  : ORIGIN = 0x00400200 , LENGTH = (0x00020000 - 0x200) /* 32KB of RAM2 is being used by */
    M4F_RAM2  : ORIGIN = 0x00420000 , LENGTH = 0x00038000 /* RAM2 */
