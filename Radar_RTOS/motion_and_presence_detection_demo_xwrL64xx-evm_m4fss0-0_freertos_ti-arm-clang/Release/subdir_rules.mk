...
build-513526401: ../example.syscfg
	...
	"C:/ti/sysconfig_1.20.0/sysconfig_cli.bat" --script "C:/Users/kevin/workspace_ccstheia/motion_and_presence_detection_demo_xwrL64xx-evm_m4fss0-0_freertos_ti-arm-clang/example.syscfg" -o "syscfg" -s "C:/ti/MMWAVE_L_SDK_05_05_04_02/.metadata/product.json" -p "FCCSP" -r "Default" --context "m4fss0-0" --compiler ticlang
	@echo 'Finished building: "$<"'
	@echo ' '
